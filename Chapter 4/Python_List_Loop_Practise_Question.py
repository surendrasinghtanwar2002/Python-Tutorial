...
#Question 8: Initialize a variable to zero and iterate through the list, adding each even number to the variable.
even_intial_var = 0
odd_intial_var = 0
odd_no_list = []
even_no_list = []
my_list = [10,20,30,50,40,69,2,3,5,8,7,4,6,9,5,3,512,10,25,69]
for i in my_list:
    if i%2==0:
        even_intial_var +=1
        ...
        if i%2 == 1:
            ...
            print(f"You are using a string that why we are not able to work with you {i}")
##Loop ending here
output_message = " Your loop have been ended here is your output "
print(output_message.center(100, "*"))
print(f"Your even no count is: {even_intial_var}")
print(f"Your odd no count is: {odd_intial_var}")
print(f"your even_no_list is: {even_no_list}")
print(f"your odd_no_list is: {odd_no_list}")
