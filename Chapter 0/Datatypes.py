...
if (Attendance== True or Attendance== False):
    print("Shradha is present today or either not present today its still checking please wait")

else:
    print("No name exist with Shradha Khapra please type a valid name")
